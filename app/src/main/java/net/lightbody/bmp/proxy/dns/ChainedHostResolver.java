 ...
 *     <li>{@link net.lightbody.bmp.proxy.dns.AdvancedHostResolver#remapHosts(Map)}</li>
 ...
 *     <li>{@link net.lightbody.bmp.proxy.dns.AdvancedHostResolver#setNegativeDNSCacheTimeout(int, TimeUnit)}</li>
 *     <li>{@link net.lightbody.bmp.proxy.dns.AdvancedHostResolver#setPositiveDNSCacheTimeout(int, TimeUnit)}</li>
