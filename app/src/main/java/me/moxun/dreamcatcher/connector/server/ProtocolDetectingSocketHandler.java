 ...
 * and backwards compatibility reasons to maintain DreamCatcher having just one actual socket
...
public class ProtocolDetectingSocketHandler extends SecureSocketHandler {
  ...
  public void addHandler(MagicMatcher magicMatcher, SocketLikeHandler handler) {
    ...
    LogUtil.d("Add handler to ProtocolDetectingSocketHandler ==>" + handler.getClass().getSimpleName());
  }

  //called on onAccepted
  @Override
